...
function fmtDefault( embed, sorted, globals, position, page = 1, Chicken ){
	let fields = [];
...
module.exports = function( Chicken, globals, page = 1 ){
	...
	fmtter( embed, sorted, globals, position, page, Chicken );
