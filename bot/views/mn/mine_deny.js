...
module.exports = function( lToken, timeSinceLastMine ){
	let embed = {
		"embed": {
			"title": "\"I don't think so!\"",
			"description": `*You're still tired from the last mining session!*\nYou can mine again in [ ***${ Math.max(0,Math.floor((lToken.userData.pickaxe_time * 60 * 1000 - timeSinceLastMine)/1000)) }*** ] Seconds.`,
			"color": 0xff6666,
			"author":{
				"name":"Mr. M. Iner",
